...
class AdminDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $opdData = [
            'Kominfo' => Article::where('opd_id', 'Kominfo')->count(),
            'BKD'     => Article::where('opd_id', 'BKD')->count(),
            'Bappeda' => Article::where('opd_id', 'Bappeda')->count(),
            'Dinkes'  => Article::where('opd_id', 'Dinkes')->count(),
            'Disdik'  => Article::where('opd_id', 'Disdik')->count(),
            'Inspektorat' => Article::where('opd_id', 'Inspektorat')->count(),
        ];
