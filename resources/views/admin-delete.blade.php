    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F8FAFC] p-4 md:p-8 relative w-full">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 fade-in-up" style="animation-delay: 0.1s;">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Recycle Bin. Berisi artikel yang sudah dihapus sementara.</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            ...
                            <td class="px-4 py-4 text-gray-600">
                                {{ $article->deleted_at ? $article->deleted_at->format('d M Y') : '-' }}
                            </td>
                                ...
                                <div class="relative inline-block">
                                    ...
                                    <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-xl z-20 origin-top-right scale-95 opacity-0">
                                        <div class="py-1">
                                            ...
                                            <!-- Force Delete -->
                                            <form action="{{ route('admin.articles.forceDelete', $article->id) ?? '#' }}" method="POST" class="block" onsubmit="return confirm('Hapus artikel secara permanen? Aksi ini TIDAK BISA dibatalkan.')">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="px-4 py-8 text-center text-gray-500 text-sm">Recycle Bin kosong.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
