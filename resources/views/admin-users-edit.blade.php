...
<head>
    ...
    <title>Edit Pengguna - AKSARA</title>
...
<body class="font-sans antialiased text-textmain bg-lightbg flex h-screen overflow-hidden">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F8FAFC] p-4 md:p-8 relative w-full">
        ...
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Edit Data: {{ $user->name }}</h1>
                <p class="text-sm text-gray-500 mt-1">Perbarui informasi profil atau akses role pengguna.</p>
            </div>
            ...
            <form action="/admin/users/{{ $user->id }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-darkbg focus:border-darkbg outline-none transition-all">
                    </div>

                    <!-- Email -->
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-gray-700">Alamat Email <span class="text-red-500">*</span></label>
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-darkbg focus:border-darkbg outline-none transition-all">
                    </div>

                    <!-- NIP -->
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-gray-700">NIP / ID Pegawai</label>
                        <input type="text" name="nip" value="{{ old('nip', $user->nip) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-darkbg focus:border-darkbg outline-none transition-all">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="jabatan" value="{{ old('jabatan', $user->jabatan) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-darkbg focus:border-darkbg outline-none transition-all">
                    </div>

                    <!-- Bidang -->
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-gray-700">Bidang / Unit Kerja</label>
                        <input type="text" name="bidang" value="{{ old('bidang', $user->bidang) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-darkbg focus:border-darkbg outline-none transition-all">
                    </div>
                </div>
                ...
                <div class="border-t border-gray-100 pt-6 flex gap-3 justify-end">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-darkbg text-white font-medium rounded-lg hover:bg-gray-800 transition-colors shadow-sm">Simpan Perubahan</button>
                </div>
            </form>
        </div>
