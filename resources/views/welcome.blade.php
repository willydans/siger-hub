...
<body class="font-sans antialiased text-gray-800 bg-lightbg overflow-x-hidden">
    ...
    <!-- FOTO 3: Public SOPs & GUIDELINES (✅ DIPERBAIKI MENJADI TAG <a>) -->
    <section id="dokumen-publik" class="py-8 px-4 sm:px-8 max-w-7xl mx-auto scroll-mt-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <!-- ✅ PERBAIKAN: Ubah <div> menjadi <a> agar bisa diklik dan membuka document-detail -->
            <a href="{{ route('document.detail', $article->slug ?? $article->id) }}" class="block bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 scroll-hidden obs-element flex flex-col" style="transition-delay: {{ $loop->iteration * 100 }}ms;">
    ...
    <section class="py-8 px-4 sm:px-8 max-w-7xl mx-auto border-t border-gray-100 scroll-hidden obs-element relative group section-carousel">
        ...
        <div class="relative px-4 sm:px-8">
            ...
            <div data-scroll-container class="flex overflow-x-auto gap-6 scroll-smooth no-scrollbar py-2">
                ...
                <!-- ✅ PERBAIKAN: Ubah <div> menjadi <a> -->
                <a href="{{ route('document.detail', $article->slug ?? $article->id) }}" class="block min-w-[280px] sm:min-w-[260px] bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col group flex-shrink-0">
