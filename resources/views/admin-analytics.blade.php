            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex justify-between items-center border-b border-gray-100 pb-2 hover:bg-gray-50 -mx-2 px-2 rounded transition-colors">
                        <span class="font-medium text-gray-700 text-sm">{{ $search['keyword'] }}</span>
                        <span class="text-xs font-bold text-gray-400">{{ $search['count_formatted'] }} Pencarian</span>
                    </li>
                    @endforeach
                </ul>
            </div>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex justify-between items-center border-b border-gray-100 pb-3">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="bg-red-100 text-red-700 text-[10px] font-bold px-2 py-0.5 rounded-full">{{ $gap['article_count'] }} Artikel</span>
                            <span class="text-xs font-bold text-gray-400">{{ $gap['search_count'] }} Pencarian</span>
                        </div>
                    </li>
                    @endforeach
                </ul>
