...
<body class="font-sans antialiased text-textmain bg-lightbg flex h-screen overflow-hidden">
    ...
    <div id="sidebar-overlay" class="fixed inset-0 bg-black/50 z-30 hidden md:hidden opacity-0" onclick="toggleSidebar()"></div>
        ...
        <!-- SIDEBAR (Dipertahankan persis, dengan Activity Log sebagai menu aktif) -->
    <aside id="sidebar-mobile" class="w-64 bg-darkbg text-gray-300 flex flex-col border-r border-gray-800 shadow-2xl z-40 fixed md:relative inset-y-0 left-0 transform -translate-x-full md:translate-x-0 flex-shrink-0 sidebar-scroll">
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            <!-- Menu Utama 7: Activity Log (Sedang Aktif) -->
            <a href="/admin/activity" class="flex items-center gap-3 bg-gray-800/50 text-white px-3 py-2.5 rounded-lg text-sm font-medium transition-colors border border-gray-700">
            ...
            <!-- Menu Utama 8: Single Links Lainnya (Semua tautan sudah diperbaiki) -->
    ...
    <!-- MAIN CONTENT (Activity Log Page) -->
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F8FAFC] p-4 md:p-8 relative w-full">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 fade-in-up" style="animation-delay: 0.1s;">
            ...
            <div class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                <button onclick="alert('Ekspor ke PDF berhasil!')" class="flex-1 md:flex-none bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg text-xs transition-colors shadow-sm hover:shadow flex items-center justify-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                    Export PDF
                </button>
                <button onclick="alert('Ekspor ke Excel berhasil!')" class="flex-1 md:flex-none bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg text-xs transition-colors shadow-sm hover:shadow flex items-center justify-center gap-1">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 mb-6 fade-in-up" style="animation-delay: 0.2s;">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <div>
                    ...
                    <input type="text" placeholder="Cari user..." class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Tanggal</label>
                    <input type="date" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300">
                </div>
                <div>
                    ...
                    <select class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300 bg-white text-gray-700">
                        <option>Semua</option>
                        <option>Upload Artikel</option>
                        <option>Approve Artikel</option>
                        <option>Login</option>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Contoh: 192.168.1.1" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300">
                </div>
                <div class="sm:col-span-2 lg:col-span-1">
                    <label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Device / Browser</label>
                    <input type="text" placeholder="Contoh: Chrome / Windows" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300">
                </div>
                <div class="sm:col-span-2 lg:col-span-2 flex items-end justify-end">
                    <button class="w-full sm:w-auto bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded-lg text-sm font-medium transition-colors duration-200">Terapkan Filter</button>
                </div>
            </div>
        </div>
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            ...
                            <td class="px-4 py-4 text-gray-600 font-medium">08.20</td>
                            <td class="px-4 py-4 text-gray-900 font-medium">Wildan</td>
                            <td class="px-4 py-4"><span class="bg-blue-100 text-blue-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Upload Artikel</span></td>
                            <td class="px-4 py-4 text-gray-600">192.168.1.10</td>
                            <td class="px-4 py-4 text-gray-600">Chrome / Windows</td>
                        </tr>
                        
                        <!-- Row 2 -->
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            <td class="px-4 py-4"><input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-gold focus:ring-gold cursor-pointer"></td>
                            <td class="px-4 py-4 text-gray-600 font-medium">08.23</td>
                            <td class="px-4 py-4 text-gray-900 font-medium">Admin</td>
                            <td class="px-4 py-4"><span class="bg-green-100 text-green-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Approve Artikel</span></td>
                            <td class="px-4 py-4 text-gray-600">192.168.1.1</td>
                            <td class="px-4 py-4 text-gray-600">Chrome / Windows</td>
                        </tr>
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            <td class="px-4 py-4"><input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-gold focus:ring-gold cursor-pointer"></td>
                            <td class="px-4 py-4 text-gray-600 font-medium">08.40</td>
                            <td class="px-4 py-4 text-gray-900 font-medium">Rina</td>
                            <td class="px-4 py-4"><span class="bg-purple-100 text-purple-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Login</span></td>
                            <td class="px-4 py-4 text-gray-600">10.0.0.5</td>
                            <td class="px-4 py-4 text-gray-600">Safari / iOS</td>
                        </tr>
                        
                        <!-- Row 4 -->
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            <td class="px-4 py-4"><input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-gold focus:ring-gold cursor-pointer"></td>
                            <td class="px-4 py-4 text-gray-600 font-medium">09.15</td>
                            <td class="px-4 py-4 text-gray-900 font-medium">Andi</td>
                            <td class="px-4 py-4"><span class="bg-red-100 text-red-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Delete Draft</span></td>
                            <td class="px-4 py-4 text-gray-600">192.168.1.15</td>
                            <td class="px-4 py-4 text-gray-600">Firefox / Mac</td>
                        </tr>
                        
                        <!-- Row 5 -->
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            <td class="px-4 py-4"><input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-gold focus:ring-gold cursor-pointer"></td>
                            <td class="px-4 py-4 text-gray-600 font-medium">10.05</td>
                            <td class="px-4 py-4 text-gray-900 font-medium">Wildan</td>
                            <td class="px-4 py-4"><span class="bg-yellow-100 text-yellow-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Edit Artikel</span></td>
                            <td class="px-4 py-4 text-gray-600">192.168.1.10</td>
                            <td class="px-4 py-4 text-gray-600">Chrome / Windows</td>
                        </tr>
                    </tbody>
