...
<body class="font-sans antialiased text-textmain bg-lightbg flex h-screen overflow-hidden">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto bg-[#F8FAFC] p-4 md:p-8 relative w-full">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 fade-in-up" style="animation-delay: 0.1s;">
            ...
            <a href="/admin/users/create" class="w-full md:w-auto bg-darkbg text-center text-white hover:bg-gray-800 font-bold py-2 px-6 rounded-lg text-sm transition-all duration-200 shadow-sm hover:shadow-md hover:scale-105">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors duration-200">
                            ...
                            <td class="px-4 py-4">
                                @if($user->role === 'admin')
                                    <span class="bg-purple-100 text-purple-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Admin</span>
                                @elseif($user->role === 'staff')
                                    <span class="bg-blue-100 text-blue-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Staff</span>
                                @else
                                    <span class="bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full text-[10px] font-bold">User</span>
                                @endif
                            </td>
                            <td class="px-4 py-4">
                                @if($user->is_active)
                                    <span class="bg-green-100 text-green-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Active</span>
                                @else
                                    <span class="bg-red-100 text-red-700 px-2.5 py-1 rounded-full text-[10px] font-bold">Inactive</span>
                                @endif
                            </td>
                            ...
                            <td class="px-4 py-4 text-center relative">
                                ...
                                <div class="relative inline-block">
                                    ...
                                    <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-xl z-20 origin-top-right scale-95 opacity-0">
                                        <div class="py-1">
                                            <!-- Gunakan URL statis jika routes tidak ditemukan -->
                                            <a href="/admin/users/{{ $user->id }}/edit" class="flex items-center gap-2 w-full text-left px-4 py-2 text-xs text-blue-600 hover:bg-blue-50 transition-colors">
                                            ...
                                            <form action="/admin/users/{{ $user->id }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                                                @csrf
                                                @method('DELETE')
