...
<body class="font-sans antialiased text-textmain bg-lightbg flex h-screen overflow-hidden">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto p-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <button class="bg-gold hover:bg-goldhover text-darkbg font-bold py-2.5 px-5 rounded-lg text-sm shadow-md transition-colors">+ Tambah Staf Baru</button>
        </div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4"><span class="bg-red-100 text-red-700 px-2 py-1 rounded text-[10px] font-bold">Admin</span></td>
                        <td class="px-6 py-4"><span class="text-green-600 font-bold text-xs">Aktif</span></td>
                        <td class="px-6 py-4 text-right">
                            <span class="text-gray-400 text-xs italic">Akses Sistem</span>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <p class="font-bold text-gray-900">Budi ASN</p>
                            <p class="text-xs text-gray-500">budi@lampungprov.go.id</p>
                        </td>
                        <td class="px-6 py-4">
                            <select class="border border-gray-300 rounded px-2 py-1 text-xs font-bold bg-blue-50 text-blue-700 outline-none cursor-pointer">
                        ...
                        <td class="px-6 py-4"><span class="text-green-600 font-bold text-xs">Aktif</span></td>
                        <td class="px-6 py-4 text-right">
                            <button class="text-red-500 hover:underline text-xs mr-3">Suspend</button>
                            <button class="text-blue-600 hover:underline text-xs">Edit Detail</button>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <p class="font-bold text-gray-900">Agus Masyarakat</p>
                            <p class="text-xs text-gray-500">agus@gmail.com</p>
                        </td>
                        <td class="px-6 py-4">
                            <select class="border border-gray-300 rounded px-2 py-1 text-xs font-bold bg-gray-100 text-gray-700 outline-none cursor-pointer">
                                <option>Staff</option>
                                <option>Admin</option>
                                <option selected>User</option>
                            </select>
                        </td>
                        <td class="px-6 py-4"><span class="text-gray-500 font-bold text-xs">Tidak Aktif</span></td>
                        <td class="px-6 py-4 text-right">
                            <button class="text-red-500 hover:underline text-xs mr-3">Hapus Akun</button>
                        </td>
                    </tr>
                </tbody>
            </table>
