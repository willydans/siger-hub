        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
            ...
            <div>
                ...
                <div id="submenu-knowledge" class="submenu hidden pl-9 space-y-1 mt-1">
                    ...
                    <a href="{{ route('admin.pending-approval') }}" class="block text-gray-400 hover:text-white text-[13px] py-1.5 transition-colors flex items-center justify-between {{ request()->routeIs('admin.pending-approval') ? 'text-white' : '' }}">• Pending Approval</a>
                    ...
                    <!-- Active State untuk halaman Revision -->
                ...
                <table class="w-full text-left text-sm">
                    <thead class="bg-gray-50 text-[11px] uppercase text-gray-500 font-bold border-b border-gray-200 whitespace-nowrap">
                        <tr>
                            ...
                            <th class="px-4 py-4 min-w-[200px]">Catatan</th>
                            <th class="px-4 py-4 min-w-[120px]">Status</th>
                            <th class="px-4 py-4 min-w-[120px]">Deadline</th>
